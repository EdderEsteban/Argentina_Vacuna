...
function enviarFormularioEditarPaciente() {
    ...
    const formPacienteData = {
        ...
        fecha_nacimiento: formEditarPaciente.fecha_nacimiento.value || null,
        genero: formEditarPaciente.genero.value || null,
        localidad: formEditarPaciente.localidad.value.trim() || null,
